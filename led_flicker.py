...
def turn_off_leds(ledoff):
  [ set_led_brightness(x, 0) for x in ledoff ]
...
while True:
  ...
  if t  > 1:
     ...
     turn_off_leds(available_leds)
     print("flicker: " + str(flicker_idx) + " loop: " + str(loop_led) + " - deme: " + str(current_led)+ " - loop duration: " + str(round(pulse_speed / 1000, 3)))
