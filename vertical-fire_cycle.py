...
while True:
    ...
    t = (time.ticks_ms()-start) / cycle_speed
    t_cycle = t % 1

    fire_colours = [graphics.create_pen(0, 0, 0),
                graphics.create_pen(1, 20, 20),
                graphics.create_pen_hsv(t_cycle, 1,  0.35),
                graphics.create_pen_hsv(t_cycle, 1, 0.8),
                graphics.create_pen_hsv(t_cycle, 0.25, 1)]
